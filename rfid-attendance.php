...
class RFIDAttendance {
    ...
    public function scanRFID($rfidCode) {
        try {
            ...
            $deviceLocation = $_GET['location'] ?? 'Main Gate';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Handle requests for recent scans
    if (isset($_GET['recent'])) {
        ...
        include 'views/rfid-attendance-view.php';
    }
